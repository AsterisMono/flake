...
- `Theme.barGlass` — one denser backing (0.68) used by both bars only, so a bright or light wallpaper no longer dominates the bar. Text stays fully opaque, and the popups keep 0.40.
